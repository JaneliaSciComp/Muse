function compile_feval_blob_from_voc_indicators_and_ancillary_executable()
...
old_dir=pwd();
cd(bin_dir_name);
mcc -R -singleCompThread -m -N -p images -p signal -p stats -v feval_blob_from_voc_indicators_and_ancillary_executable.m
cd(old_dir);
