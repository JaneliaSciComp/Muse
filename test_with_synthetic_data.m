...
[r_est,mse_min,mse_grid,a,vel,N_filt,V_filt,V]= ...
...
rmse_grid=1000*sqrt(mse_grid);  % V -> mV
[fig_h,axes_h,axes_cb_h]= ...
  figure_objective_map(x_grid,y_grid,rmse_grid, ...
                       'jet', ...
                       [], ...
...
% add some noise to the mic positions
R_noisy=R+[normrnd(0,0.02,2,4); 0 0 0 0];
                
% estimate the mouse position with the true mic positions
[r_est_noisy,mse_min,mse_grid,a,vel,N_filt,V_filt,V]= ...
  r_est_from_clip(v_clip,fs, ...
                  f_lo,f_hi, ...
                  Temp, ...
                  x_grid,y_grid,in_cage, ...
...
[fig_h,axes_h,axes_cb_h]= ...
  figure_objective_map(x_grid,y_grid,rmse_grid, ...
                       'jet', ...
                       [], ...
                       'Estimate with error-y mic positions', ...
                       'RMSE (mV)', ...
                       clr_mike, ...
                       [1 1 1], ...
                       r_est_noisy,[], ...
                       R_noisy,r_true,r_true+[-0.08 0]');
