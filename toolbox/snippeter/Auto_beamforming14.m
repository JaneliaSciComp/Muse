...
da_folder_number = 'Data_analysis10';

path_d_list = cell(0,1);
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\10072012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\09042012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\08212012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\08232012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\09122012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\10052012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\10062012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\10082012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\11102012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\11122012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\12312012\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\01012013\';%;
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\01022013\';%
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_vocal_structure\03032013\';%

%number 15-20 single mouse
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_sys_test\sys_test_06052012\';
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_sys_test\sys_test_06062012\';
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_sys_test\sys_test_06102012\';
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_sys_test\sys_test_06112012\';
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_sys_test\sys_test_06122012\';
path_d_list{end+1,1} = 'A:\Neunuebel\ssl_sys_test\sys_test_06132012\';

%creat syl list
creat_syl_list_playback = 'y';%based on AX output files
...
%     path_d = char(path_d_list(data_set,1));
    ...
    for ses_num = 1:size(Experiment_list,1)
        tmp_exp_list = char(Experiment_list(ses_num,1));
        let_str = tmp_exp_list(6);
        %velocity of sound
        T = temps(ses_num,1);
        ...
        if strcmp(creat_syl_list_playback,'y')==1  %creates structure unless one is saved
            tmp_voc_str_name = sprintf('*_%s_*',let_str);
            voc_list_name = sprintf('Test_%s_1_voc_list_no_merge_har.mat',let_str);
            cd (dir1)
            cd no_merge_only_har
            tmp_voc_str = dir(tmp_voc_str_name);
            cd (tmp_voc_str.name)
            load (voc_list_name)
        ...
        toc
        cd (saving_dir)
        save(sprintf('%s_Mouse',video_fname_prefix),'mouse')%voc data
        save(sprintf('%s_Mouse_Video',video_fname_prefix),'mouse_video')%video data
