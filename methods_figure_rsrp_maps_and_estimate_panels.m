...
[r_head_from_video_pretty,r_tail_from_video_pretty]= ...
...
% probability
r_head_from_video_real_and_fake=[r_head_from_video_pretty r_head_from_video_fake];
r_tail_from_video_real_and_fake=[r_tail_from_video_pretty r_tail_from_video_fake];
...
place_objective_map_in_axes_custom(axes_h, ...
                                   ...
                                   do_draw_mic_labels);
z_mice=1;                          
draw_mice_given_head_and_tail(axes_h,100*r_head_from_video_pretty,100*r_tail_from_video_pretty,z_mice,clr_mouse);
